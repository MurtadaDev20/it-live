...
<?php
global $con;
$sql = "SELECT * FROM users where statuse = '0'  ORDER BY id DESC";
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">معلومات المتطوعين</h3>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="pt-3">
                                            <a class="btn btn-danger btn-md" href="volunteer_del.php?id=<?php echo $row['id'] ?>"><i class="fas fa-trash"></i></a>
                                        </td>
